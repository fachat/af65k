...
when "0100000010" =>          -- $02, LEA Zeropage indexed with Y: zp,Y  (65k)
  ...
  parwidth <= pw_bl;
  admode <= sABSOLUTEIND;
when "0100000100" =>          -- $04, MVN Implied:   (65k10)
  operation <= xMVN;
  admode <= sIMPLIED;
...
when "0100001110" =>          -- $0e, ASR Absolute 16bit: abs  (65k)
  ...
  parwidth <= pw_wq;
  admode <= sABSOLUTE;
when "0100001111" =>          -- $0f, ASL Absolute 16bit indexed with Y: abs,Y  (65k)
  operation <= xASL;
  idxreg <= iYR;
  parwidth <= pw_wq;
  admode <= sABSOLUTEIND;
when "0100010100" =>          -- $14, MVP Implied:   (65k10)
  operation <= xMVP;
  admode <= sIMPLIED;
when "0100010110" =>          -- $16, ASR Zeropage indexed with X: zp,X  (65k)
  ...
  parwidth <= pw_bl;
  admode <= sABSOLUTEIND;
when "0100011000" =>          -- $18, HBC Accumulator:   (65k10)
  operation <= xHBC_A;
  admode <= sIMPLIED;
...
when "0100100010" =>          -- $22, PEA Zeropage indexed with Y: zp,Y  (65k)
  ...
  parwidth <= pw_bl;
  admode <= sABSOLUTEIND;
when "0100100100" =>          -- $24, FIL Implied:   (65k10)
  operation <= xFIL;
  admode <= sIMPLIED;
...
when "0100101110" =>          -- $2e, RDL Absolute 16bit: abs  (65k)
  ...
  parwidth <= pw_wq;
  admode <= sABSOLUTE;
when "0100101111" =>          -- $2f, ROL Absolute 16bit indexed with Y: abs,Y  (65k)
  operation <= xROL;
  idxreg <= iYR;
  parwidth <= pw_wq;
  admode <= sABSOLUTEIND;
when "0100110100" =>          -- $34, BIT Accumulator:   (65k)
  operation <= xBIT_A;
  admode <= sIMPLIED;
...
when "0100110110" =>          -- $36, RDL Zeropage indexed with X: zp,X  (65k)
  ...
  parwidth <= pw_bl;
  admode <= sABSOLUTEIND;
when "0100111000" =>          -- $38, BSW Accumulator:   (65k10)
  operation <= xBSW_A;
  admode <= sIMPLIED;
...
when "0101001101" =>          -- $4d, LSR E indirect: (E)  (65k)
  operation <= xLSR;
  admode <= sEINDIRECT;
when "0101001111" =>          -- $4f, LSR Absolute 16bit indexed with Y: abs,Y  (65k)
  operation <= xLSR;
  idxreg <= iYR;
  parwidth <= pw_wq;
  admode <= sABSOLUTEIND;
...
when "0101100010" =>          -- $62, LEA Absolute indexed with X indirect 16bit: (abs,X)  (65k)
  ...
  parwidth <= pWORD;
  admode <= sPREINDIRECT;
when "0101100100" =>          -- $64, RMB Implied:   (65k10)
  operation <= xRMB;
  admode <= sIMPLIED;
...
when "0101101110" =>          -- $6e, RDR Absolute 16bit: abs 
  ...
  parwidth <= pw_wq;
  admode <= sABSOLUTE;
when "0101101111" =>          -- $6f, ROR Absolute 16bit indexed with Y: abs,Y  (65k)
  operation <= xROR;
  idxreg <= iYR;
  parwidth <= pw_wq;
  admode <= sABSOLUTEIND;
when "0101110100" =>          -- $74, WMB Implied:   (65k10)
  operation <= xWMB;
  admode <= sIMPLIED;
...
when "0101110110" =>          -- $76, RDR Zeropage indexed with X: zp,X 
  ...
  parwidth <= pw_bl;
  admode <= sABSOLUTEIND;
when "0101111000" =>          -- $78, HBS Accumulator:   (65k10)
  operation <= xHBS_A;
  admode <= sIMPLIED;
...
when "0110001110" =>          -- $8e, STX E indirect: (E)  (65k)
  operation <= xSTX;
  admode <= sEINDIRECT;
when "0110001111" =>          -- $8f, STY Absolute 16bit indexed with X: abs,X  (65k)
  operation <= xSTY;
  idxreg <= iXR;
  parwidth <= pw_wq;
  admode <= sABSOLUTEIND;
when "0110010000" =>          -- $90, BLE Relative: rel  (65k)
  operation <= xBLE;
  parwidth <= pw_rs;
  admode <= sREL;
...
when "0110101001" =>          -- $a9, LDA E indirect: (E)  (65k)
  ...
  default_le <= eZERO;
  admode <= sEINDIRECT;
when "0110101100" =>          -- $ac, PSH Implied:   (65k10)
  operation <= xPSH;
  admode <= sIMPLIED;
...
when "0110101110" =>          -- $ae, LEA Absolute 16bit: abs  (65k)
  ...
  parwidth <= pw_wq;
  admode <= sABSOLUTE;
when "0110101111" =>          -- $af, STX Absolute 16bit indexed with Y: abs,Y  (65k)
  operation <= xSTX;
  idxreg <= iYR;
  parwidth <= pw_wq;
  admode <= sABSOLUTEIND;
when "0110110000" =>          -- $b0, BGT Relative: rel  (65k)
  operation <= xBGT;
  parwidth <= pw_rs;
  admode <= sREL;
...
when "0111001010" =>          -- $ca, TSY Implied:   (65k)
  operation <= xTSY;
  admode <= sIMPLIED;
when "0111001100" =>          -- $cc, PLL Implied:   (65k10)
  operation <= xPLL;
  admode <= sIMPLIED;
when "0111001101" =>          -- $cd, DEC E indirect: (E)  (65k)
  operation <= xDEC;
  admode <= sEINDIRECT;
when "0111001111" =>          -- $cf, DEC Absolute 16bit indexed with Y: abs,Y  (65k)
  operation <= xDEC;
  idxreg <= iYR;
  parwidth <= pw_wq;
  admode <= sABSOLUTEIND;
...
when "0111101101" =>          -- $ed, INC E indirect: (E)  (65k)
  operation <= xINC;
  admode <= sEINDIRECT;
when "0111101111" =>          -- $ef, INC Absolute 16bit indexed with Y: abs,Y  (65k)
  operation <= xINC;
  idxreg <= iYR;
  parwidth <= pw_wq;
  admode <= sABSOLUTEIND;
